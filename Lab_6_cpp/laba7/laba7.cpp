...
HICON hIcon = (HICON)LoadImage(NULL, L"santa-claus.ico", IMAGE_ICON, 128, 128, LR_LOADFROMFILE);
HICON hIcon2 = (HICON)LoadImage(NULL, L"santa-claus-mirror.ico", IMAGE_ICON, 128, 128, LR_LOADFROMFILE);
